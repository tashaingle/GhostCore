...
export const maintenanceJobs:JobRegistration[]=[
 ...
 {key:"workflow.dispatch",type:"workflow.dispatch",scheduleType:"recurring",scheduleValue:"5m",timeout:300},
 {key:"workflow.timeout",type:"workflow.timeout",scheduleType:"recurring",scheduleValue:"15m"},
 {key:"approval.reminders",type:"approval.reminders",scheduleType:"recurring",scheduleValue:"1h"},
 {key:"work.recurring.generate",type:"work.recurring.generate",scheduleType:"recurring",scheduleValue:"15m",timeout:300},
 {key:"work.sla.evaluate",type:"work.sla.evaluate",scheduleType:"recurring",scheduleValue:"15m",timeout:300},
 {key:"work.overdue.evaluate",type:"work.overdue.evaluate",scheduleType:"recurring",scheduleValue:"15m",timeout:300},
 {key:"work.maintenance",type:"work.maintenance",scheduleType:"recurring",scheduleValue:"1d",timeout:300},
 {key:"workflow.cleanup",type:"workflow.cleanup",scheduleType:"recurring",scheduleValue:"1d",configuration:{retentionDays:365}},
